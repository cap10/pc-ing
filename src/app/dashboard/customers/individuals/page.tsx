...
import { getIndividualCustomers } from "@/shared/services/main-service";
    ...
    return (
        <main>
            <div className="md:flex items-center justify-between px-[2px] mb-5">
                <h4 className="text-[18px] font-medium text-gray-800 mb-sm-0 grow mb-2 md:mb-0" id="moduleName">Individual Customers</h4>
                <Link href="/dashboard/customers/individuals/new" className="button p-1 text-white bg-color-secondary rounded-md">
                            ...
                            {customers?.map((u: any) => (
                                <tr className="bg-white border border-gray-200" key={u.id}>
                                    ...
                                    <td className="text-center">
                                        <Link href={"individuals/"+u.id} title="View Customer" className="text-color-secondary px-1 py-0.5 cursor-pointer"><i className="fa-solid fa-eye"></i></Link>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
