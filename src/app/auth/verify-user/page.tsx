                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="space-y-3 mb-6">
                                            <p className="text-sm sm:text-base text-green-700 font-medium">
                                                Your account verification has completed successfully.
                                            </p>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="space-y-3 mb-6">
                                            <p className="text-sm sm:text-base text-red-700 font-medium">
                                                We couldn't complete your account verification please contact Admin.
                                            </p>
                                            ...
                                            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-red-200">
                                                <div className="space-y-2 text-sm">
                                                    ...
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className="font-semibold text-red-700">Link Expired</span>
                                                    </div>
                                                    <div className="flex justify-between">
                                                        <span className="text-gray-600">Status:</span>
                                            ...
                                            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                                                <div className="flex items-start">
                                                    ...
                                                    <p className="text-xs sm:text-sm text-amber-700">
                                                        Please contact admin to verify your account and try again.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="w-full max-w-md">
                        ...
                        <div
                            ...
                            <div className="px-8 pt-8 pb-6 bg-gradient-to-r from-cyan-500 to-indigo-400">
                                <div className="text-center">
                                    <div
                                        className="mx-auto mb-4 w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <p className="text-blue-100 text-sm">Please verify your account to continue</p>
                                </div>
                            </div>

                            {/* Form Content */}
                            <div className="px-8 py-8">
                                <div className="space-y-6" onSubmit={SetPasswordForm.handleSubmit}>

                                    {/* Username Confirmation */}
                                    <div className="text-center space-y-3">
                                        <p className="text-gray-600 font-medium">Confirm your username</p>
                                        <div
                                    ...
                                    <div className="pt-2">
                                        <button
                                            className="w-full bg-gradient-to-r from-cyan-400 to-indigo-500 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                                            disabled={SetPasswordForm.isSubmitting}
                                            type="submit"
                                            onClick={SetPasswordForm.handleSubmit}
                                        >
