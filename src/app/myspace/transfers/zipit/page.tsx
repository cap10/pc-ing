...
const preAuthValidationSchema = Yup.object({
    ...
    destinationBin: Yup.string().required('Destination bank required'),
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="space-y-3 mb-6">
                                        <p className="text-sm sm:text-base text-red-700 font-medium">
                                            We couldn't complete your zipit transfer.
                                        </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
                ...
                <div
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4 mb-4 md:mb-0">
                        ...
                        <div>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">ZIPIT
                                Transfer</h2>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div
                    ...
                    <div className="flex items-center space-x-3 mb-4 md:mb-0">
                        ...
                        <div>
                            <h2 className="text-xl md:text-2xl font-bold text-gray-800">Zipit Transfer</h2>
