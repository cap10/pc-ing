                                        ...
                                        <div className="bg-white/70 backdrop-blur-sm rounded-lg p-4 border border-red-200">
                                            <div className="space-y-2 text-sm">
                                                ...
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="font-semibold text-red-700">Insufficient Balance</span>
                                                </div>
                                                <div className="flex justify-between">
                                                    <span className="text-gray-600">Status:</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 relative z-10">
                ...
                <div
                    ...
                    <div className="flex items-center space-x-3 sm:space-x-4 mb-4 md:mb-0">
                        ...
                        <div>
                            <h2 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">Internal
                                Transfer</h2>
