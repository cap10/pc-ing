...
export default function Airtime() {
    ...
    useEffect(() => {
        //get customers
        axiosClient.get(`v1/products/products-list-category/AIRTIME`)
            .then((res:any) =>{
    ...
    products.forEach(function(product){
        ...
        if (product?.name === "Econet"){
            EconetData.push(product);
        }
        if (product?.name === "Netone"){
            NetoneData.push(product);
        }
        if (product?.name === "Telecel"){
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold mb-3">
                      <span className="bg-gradient-to-r from-blue-600 to-blue-300 bg-clip-text text-transparent">
                        ...
                        <span className="text-gray-700"> Airtime</span>
                    </h2>
                    <div
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold mb-3">
                      <span className="bg-gradient-to-r from-orange-600 to-orange-300 bg-clip-text text-transparent">
                        ...
                        <span className="text-gray-700"> Airtime Bundles</span>
                    </h2>
