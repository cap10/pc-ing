...
export default function Products() {
    ...
    useEffect(() => {
        //get customers
        axiosClient.get(`v1/products/products-list`)
            .then((res:any) =>{
    ...
    return (
        ...
        <main>
            <div className="md:flex items-center justify-between px-[2px] mb-5">
                <h4 className="text-[18px] font-medium text-gray-800 mb-sm-0 grow mb-2 md:mb-0">Products</h4>{/*
                <Link href={'/myspace/transfers'} type="button" className="p-1 text-white bg-color-primary rounded-md">Products
                    Money</Link>*/}
            </div>

            <section className="mt-5 pt-4">
                <h4 className="font-bold">Products List</h4>
                <div className="mt-5">
