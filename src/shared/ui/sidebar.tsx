        ...
        <div data-simplebar='init' className="h-full">
            ...
            <div className="metismenu pb-10 pt-4" id="sidebar-menu">
                ...
                <ul id="side-menu" className="metismenu">
                    ...
                    <li>
                        <Link href="/myspace" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                    ...
                    <li>
                        <Link href="/myspace/accounts" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                    ...
                    <li>
                        <Link href="/myspace/beneficiaries" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                            {/* <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                            </svg> */}
                            <i className="fa-solid fa-users-viewfinder text-slate-500 size-5"></i>
                    ...
                    <li>
                        <Link href="/myspace/transfers" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                    ...
                    <li>
                        <Link href="/myspace/services" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
                    ...
                    <li>
                        <Link href="/myspace/settings" className="flex py-2.5 px-6 text-sm font-medium text-gray-600 transition-all duration-150 ease-linear hover:text-color-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
