                        ...
                        <form action={myFunc}>
                            <div className="bg-white">
                                ...
                                <div className="inline-block text-center gap-3 p-3 w-full space-x-2 border-t rounded-b border-gray-50">
                                    <button onClick={() => closeModal('modal-addUser')} type="button" className="inline-flex justify-center w-auto px-3 py-1 text-base font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md shadow-sm btn hover:bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-gray-500/30 sm:mt-0 sm:text-sm " data-tw-dismiss="modal">
